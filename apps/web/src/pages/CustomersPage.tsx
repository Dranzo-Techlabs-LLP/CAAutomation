      ...
      {showForm && (
        <form onSubmit={handleCreate} className="panel space-y-3">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Field label="Brief" value={form.briefText} onChange={(v) => setForm({ ...form, briefText: v })} />
          </div>
      ...
      <div className="panel overflow-x-auto">
        <table className="w-full min-w-[700px] text-left text-sm">
          ...
          <tbody className="divide-y divide-border">
            ...
            {customers.length === 0 && (
              <tr><td colSpan={6} className="py-8 text-center text-muted-foreground">No customers found</td></tr>
            )}
          </tbody>
        </table>
      </div>
